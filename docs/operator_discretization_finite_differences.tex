...
\end{align}
If this attempt is correct, care will need to be taken to determine the result from discretize\_univariate\_diffusion.m , which is uniform grid or non-uniform grid whenever we are using the function discretize\_univariate\_diffusion.m.
