...
Define a uniform grid $k \in \set{k_1, \ldots k_I}$ for some small $k_1 > 0$ and a large $k_I$ with $\Delta \equiv k_i - k_{i-1}$.  Further define $v_i \equiv v(k_i)$.  To discretize the derivative at $k_i$, consider both backwards and forwards differences,
\begin{align}
